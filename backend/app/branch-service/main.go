...
import (
	...
	"github.com/panduputragit/gym/backend/app/branch-service/internal/config"
	servicehttp "github.com/panduputragit/gym/backend/app/branch-service/internal/http"
...
func main() {
	...
	if db != nil {
		...
		fmt.Printf("%s database disabled; set BRANCH_DATABASE_URL to enable it\n", cfg.Name)
	}
