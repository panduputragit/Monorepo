...
import (
	...
	"github.com/panduputragit/gym/backend/app/employee-service/internal/config"
	servicehttp "github.com/panduputragit/gym/backend/app/employee-service/internal/http"
...
func main() {
	...
	if db != nil {
		...
		fmt.Printf("%s database disabled; set EMPLOYEE_DATABASE_URL to enable it\n", cfg.Name)
	}
