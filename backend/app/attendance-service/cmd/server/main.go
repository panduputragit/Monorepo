...
import (
	...
	"github.com/panduputragit/gym/backend/app/attendance-service/internal/config"
	servicehttp "github.com/panduputragit/gym/backend/app/attendance-service/internal/http"
...
func main() {
	...
	if db != nil {
		...
		fmt.Printf("%s database disabled; set ATTENDANCE_DATABASE_URL to enable it\n", cfg.Name)
	}
