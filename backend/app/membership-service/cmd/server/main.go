...
import (
	...
	"github.com/panduputragit/gym/backend/app/membership-service/internal/config"
	servicehttp "github.com/panduputragit/gym/backend/app/membership-service/internal/http"
...
func main() {
	...
	if db != nil {
		...
		fmt.Printf("%s database disabled; set MEMBERSHIP_DATABASE_URL to enable it\n", cfg.Name)
	}
