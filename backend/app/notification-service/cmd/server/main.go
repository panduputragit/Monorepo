...
import (
	...
	"github.com/panduputragit/gym/backend/app/notification-service/internal/config"
	servicehttp "github.com/panduputragit/gym/backend/app/notification-service/internal/http"
...
func main() {
	...
	if db != nil {
		...
		fmt.Printf("%s database disabled; set NOTIFICATION_DATABASE_URL to enable it\n", cfg.Name)
	}
